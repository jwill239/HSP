...
VRin = vrports('T1','translation','T2','translation','T3','translation','T4','translation' ...
            ,'Hoist1','translation','Hoist2','translation','Arm1','translation','ArmStick1','height','Wrist1','translation' ...
            ,'Arm2','translation','ArmStick2','height','Wrist2','translation');
...
%Start simulation
addpath(destDir)
set_param('my_twohoists', 'simulationcommand', 'start')
sim([destDir filesep 'my_twohoists'])